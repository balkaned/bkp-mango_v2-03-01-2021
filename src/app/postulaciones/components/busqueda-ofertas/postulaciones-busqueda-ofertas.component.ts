...
@Component({
  selector: 'app-postulaciones-busqueda-ofertas',
  templateUrl: './postulaciones-busqueda-ofertas.component.html',
  styleUrls: ['./postulaciones-busqueda-ofertas.component.scss']
})
export class PostulacionesBusquedaOfertasComponent {

  busqueda$: BehaviorSubject<string>;

  @Output() busqueda: EventEmitter<string>;

  @Output() selected: EventEmitter<Postulaciones>;

  @Input() postulaciones: Postulaciones[];
