...
@Component({
  selector: 'app-postulaciones-detalles-oferta',
  templateUrl: './postulaciones-detalles-oferta.component.html',
  styleUrls: ['./postulaciones-detalles-oferta.component.scss']
})
export class PostulacionesDetallesOfertaComponent implements OnInit {
